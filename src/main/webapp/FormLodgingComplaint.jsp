...
<title>Lodging a complaint</title>
...
<body>
	<div class="container">
		...
		<div class="row">
			<div class="col-md-4">
				<form name="myForm" action="Controller?action=LODGE"
					...
					<div class="form-group">
						<select name="state">
						<option value=""> Choose your State or Residence </option>
							<option value="Johor"
					...
					<input type="submit" class="btn btn-success" name="submit"
						value="Submit" /> <input type="reset" class="btn btn-success"
